      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 2 }}>
        <Grid container spacing={4} alignItems="center" justifyContent={'center'}>
          <Grid item xs={12} md={5}>
            ...
            >
              Digital Marketing <br /> Resources & Guides
            </Typography>
            <Typography
              variant="h5"
              component="p"
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              <Button
                ...
                sx={{ borderRadius: 2 }}
                aria-label="Search our marketing guides and resources"
          ...
          <Grid item xs={12} md={6}>
            <Box
              ...
              alt="Digital marketing illustration showing various marketing channels and strategies"
              loading="lazy"
              sx={{
                width: '100%',
                height: 'auto',
